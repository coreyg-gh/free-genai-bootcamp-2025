...
def load_stored_questions():
    ...
    print("main.py - Start of load_stored_questions")
    questions_file = os.path.join(
        os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
        "backend/data/questions/stored_questions.json"
    )
    if os.path.exists(questions_file):
        with open(questions_file, 'r', encoding='utf-8') as f:
            print("main.py - os.path.exists")
            return json.load(f)
    return {}

def save_question(question, practice_type, topic, audio_file=None):
    """Save a generated question to JSON file"""
    print("main.py - Start of save_questions")
    questions_file = os.path.join(
        os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
        "backend/data/questions/stored_questions.json"
    )
    ...
    with open(questions_file, 'w', encoding='utf-8') as f:
        ...
        print("main.py - saved file")
    
    return question_id

def render_interactive_stage():
    """Render the interactive learning stage"""
    print("main.py - Start of render_interactive_stage")
    ...
    if st.button("Generate New Question"):
        print("main.py - button Generate New Question")
        ...
        print("main.py - save_question")
        save_question(new_question, practice_type, topic)
        st.session_state.current_audio = None
    
    if st.session_state.current_question:
        print("main.py - st.session_state.current_question")
        ...
        print("main.py - st.write question")
        st.write("**Question:**")
