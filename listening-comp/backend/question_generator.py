...
class QuestionGenerator:
    def __init__(self):
        ...
        print("question_generator - Start of QuestionGenerator init")
    ...
    def _invoke_bedrock(self, prompt: str) -> Optional[str]:
        ...
        print("question_generator - Start invoke_bedrock")
        try:
            messages = [{
                "role": "user",
                "content": [{
            ...
            print("question_generator - Returning response")
    ...
    def generate_similar_question(self, section_num: int, topic: str) -> Dict:
        ...
        print("question_generator - Start of generate_similar_question")
        # Get similar questions for context
        print("question_generator - call vector_store.search_similar_questions")
        similar_questions = self.vector_store.search_similar_questions(section_num, topic, n_results=3)
        
        if not similar_questions:
            print("question_generator - Returning None for not similar_questions")
            return None
        ...
        if not response:
            print("question_generator - Returning None after invoke_bedrock")
            return None
    ...
    def get_feedback(self, question: Dict, selected_answer: int) -> Dict:
        ...
        print("question_generator - Start of get_feedback")
