...
class AudioGenerator:
    def __init__(self):
        # AWS clients
        print("audio_generator - Start of class AudioGenerator")
    ...
    def _invoke_bedrock(self, prompt: str) -> str:
        ...
        print("audio_generator - Start of invoke_bedrock")
        messages = [{
            "role": "user",
            "content": [{
                "text": prompt
        ...
        print("audio_generator - In invoke bedrock, nessages:", str(messages))
        ...
        try:
            ...
            print("audio_generator - Response received, ",str(response))
    ...
    def validate_conversation_parts(self, parts: List[Tuple[str, str, str]]) -> bool:
        ...
        """
        print("audio_generator - Start of validate_conversation_parts")
        if not parts:
            print("audio_generator - Error: No conversation parts generated")
            return False
            
        # Check that we have an announcer for intro
        if not parts[0][0].lower() == 'announcer':
            print("audio_generator - Error: First speaker must be Announcer")
            return False
    ...
    def parse_conversation(self, question: Dict) -> List[Tuple[str, str, str]]:
        ...
        """
        print("audio_generator - Start of parse_conversations")
        max_retries = 2
        for attempt in range(max_retries):
            try:
                ...
                """
                print("audio_generator - Invoking bedrock")
                response = self._invoke_bedrock(prompt)
                print("audio_generator - After invoke_bedrock")
    ...
    def generate_audio_part(self, text: str, voice_name: str) -> str:
        ...
        print("audio_generator - Start of generate_audio_part")
        try:
            ...
            print(f"Error synthesize_speech: {str(e)}")
    ...
    def generate_audio(self, question: Dict) -> str:
        ...
        """
        print("audio_generator - Start of generate_audio")
